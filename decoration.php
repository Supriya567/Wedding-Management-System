...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">Trivia Wedding Planner</a>
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4">Trivia Wedding Planner</h1>
          ...
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            ...
            <div class="testimonial-box">
              <div class="author-test">
                ...
                <span class="author">Supriya Ramesh</span>
              </div>
            ...
            <div class="testimonial-box">
              <div class="author-test">
                   ...
                   <img src="img/pushkar.jpeg" alt="" class="rounded-circle b-shadow-a" style="height: 250px; width: 250px;">
                   <span class="author">Vidya</span>
              </div>
              <div class="content-test">
                <p class="description lead">
            ...
            <div class="testimonial-box">
              <div class="author-test">
                   ...
                   <img src="img/rej.jpg" alt="" class="rounded-circle b-shadow-a" style="height: 250px; width: 250px;">
                   <span class="author">Ranjitha</span>
              </div>
              <div class="content-test">
                <p class="description lead">
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="copyright-box">
              <p class="copyright">&copy; Copyright <strong>Sai Ananya J</strong>. All Rights Reserved</p>
              <div class="credits">
                <!--
                ...
                -->
                Designed by <a href="#">Sai Ananya J </a>
              </div>
            </div>
          </div>
        </div>
